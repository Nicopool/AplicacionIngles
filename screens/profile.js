    ...
    <div class="screen bg-white" style="min-height: 100vh; background: #F8FAFC; padding-bottom: 80px;">
      <div class="hangman-header" style="background:var(--bg-card); padding:16px; border-bottom:1px solid var(--border);">
        ...
        <div style="flex:1; text-align:center;">
          <div class="hangman-title" style="font-size:18px;">Mi Perfil</div>
        </div>
      ...
      <div style="padding: 0 24px;">
        <div style="background: white; border-radius: 20px; padding: 24px; box-shadow: 0 4px 6px -1px rgba(0, 0, 0, 0.05);">
          ...
          <div class="input-group" style="margin-bottom: 24px;">
            <label style="font-size: 13px; font-weight: 700; color: var(--text-secondary); margin-bottom: 8px; display: block; text-transform: uppercase; letter-spacing: 0.5px;">Nombre de usuario</label>
            <input type="text" id="edit-username" class="input-field" value="${username}" placeholder="Tu nombre" style="background: #F1F5F9; border: none; padding: 14px 16px; font-size: 16px; font-weight: 600; border-radius: 12px; width: 100%;">
          </div>

          <div class="input-group">
            <label style="font-size: 13px; font-weight: 700; color: var(--text-secondary); margin-bottom: 12px; display: block; text-transform: uppercase; letter-spacing: 0.5px;">Elige tu Avatar</label>
